...
// No need to change the following code
// The moveTo function moves a given ball to a set x and y coordinates
let movement = {
    moveTo: function(x, y){
        this.element.style.left = x + "px";
        this.element.style.top = y + "px";
    },
    // The changeDirectionIfNecessary function checks if the ball has hit the edge of the area and changes its direction if necessary
...
// TODO: implement the update function
    update: function(x,y){
        ...
        // TODO: use the javascript setTimeout() method to call changeDirectionIfNecessary() function after 100 milliseconds
...
moveTo(ball3,20,20);
 ...
 if (typeof module !== 'undefined') {
    module.exports = { update, create, changeDirectionIfNecessary, moveTo, area, movement };
}